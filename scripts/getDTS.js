...
const go = async () => {
  ...
  await getFileAndStoreLocally(
    ...
    text => {
      ...
      const replaceTSVFS = removeImports.replace("// import * as tsvfs from './vendor/typescript-vfs'", "import * as tsvfs from './typescript-vfs'")
  ...
  await getFileAndStoreLocally(
    ...
    text => {
      ...
      const replaceTSVFS = replaceSandbox.replace(/typescriptlang-org\/static\/js\/sandbox\/vendor\/typescript-vfs/g, './typescript-vfs')
